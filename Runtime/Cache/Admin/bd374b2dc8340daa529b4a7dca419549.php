...
<div class="header bg-main">
  <div class="logo margin-big-left fadein-top">
    ...
    <h1><img src="<?php echo (ADMIN_IMAGES_URL); ?>y.png" class="radius-circle rotate-hover" height="50" alt="" />学生会成员管理中心</h1>
  ...
  <div class="head-l"><a class="button button-little bg-red" href="/StudentUnion/index.php/Admin/Login/logout"><span class="icon-power-off"></span> 退出登录</a> </div>
</div>
<div class="leftnav" style="overflow-x:scroll">
  ...
  <ul> 
    <?php  echo authCheck(MODULE_NAME.'/User/listUser',cookie('id'),'<li><a href="/StudentUnion/index.php/Admin/User/listUser" target="right"><span class="icon-caret-right"></span>成员信息</a></li>'); ?>
  </ul>   
  ...
  <ul>
    <?php  echo authCheck(MODULE_NAME.'/Relative/listRela',cookie('id'),'<li><a href="/StudentUnion/index.php/Admin/Auth/listRule" target="right"><span class="icon-caret-right"></span>权限列表</a></li>'); ?>
    <?php  echo authCheck(MODULE_NAME.'/Relative/listRela',cookie('id'),'<li><a href="/StudentUnion/index.php/Admin/Auth/listGroup" target="right"><span class="icon-caret-right"></span>用户组列表</a></li>'); ?>
    <?php  echo authCheck(MODULE_NAME.'/Relative/listRela',cookie('id'),'<li><a href="/StudentUnion/index.php/Admin/Auth/listAdmin" target="right"><span class="icon-caret-right"></span>管理员列表</a></li>'); ?> 
