...
<body>
<form method="post" action="/StudentUnion/index.php/Admin/Auth/listGroup" id="listform">
  <div class="panel admin-panel">
    ...
    <?php foreach ($data as $k => $v): ?>
        <tr>
          ...
          <a class="layui-btn layui-btn layui-btn-small" ruleId="<?php echo ($v['id']); ?>" ruleName="<?php echo ($v['name']); ?>" ruleTitle="<?php echo ($v['title']); ?>" href="/StudentUnion/index.php/Admin/Auth/rule_group/id/<?php echo ($v['id']); ?>"><i class="layui-icon">&#xe614;</i>分配权限</a>
...
<!-- 添加用户组开始 -->
  <div id="groupForm" style="display: none" >
    <form style="margin-top: 40px" class="layui-form" method="post" action="/StudentUnion/index.php/Admin/Auth/addGroup">
...
<!-- 修改用户组开始 -->
  <div id="editGroup" style="display: none" >
    <form style="margin-top: 40px" class="layui-form" method="post" action="/StudentUnion/index.php/Admin/Auth/editGroup">
...
function del(id){
  if(confirm("您确定要删除吗?")){
    window.location="/StudentUnion/index.php/Admin/Auth/delGroup/id/"+id;
  }
}
