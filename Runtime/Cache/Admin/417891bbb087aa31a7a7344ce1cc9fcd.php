...
<body>
<form method="post" action="/StudentUnion/index.php/Admin/Knowledge/listKnow" id="listform">
  <div class="panel admin-panel">
    <!-- <div class="panel-head"><strong class="icon-reorder"> 内容列表</strong></div> -->
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <li> <a class="layui-btn layui-btn-primary" href="/StudentUnion/index.php/Admin/Knowledge/add"><i class="layui-icon">&#xe654;</i> 添加知识</a> </li>
    ...
    <?php foreach ($data as $k => $v): ?>
        <tr>
          ...
          <a class="layui-btn layui-btn layui-btn-mini" href="/StudentUnion/index.php/Admin/Knowledge/edit/know_id/<?php echo $v['know_id']; ?>"><i class="layui-icon">&#xe642;</i> 修改</a> 
...
function del(know_id){
	if(confirm("您确定要删除吗?")){
		window.location="/StudentUnion/index.php/Admin/Knowledge/delete/know_id/"+know_id;
	}
}
